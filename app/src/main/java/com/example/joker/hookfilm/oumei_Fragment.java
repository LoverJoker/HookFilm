...
public class oumei_Fragment extends Base_Fragment implements guonei_JsoupUtils.OnDataRight{
    ...
    public void initAdapter() {
        guonei_JsoupUtils guonei_jsoupUtils = new guonei_JsoupUtils("http://www.ygdy8.com/html/gndy/oumei/index.html", mRootActivity, mRecycle_main);
    ...
    public void getData(ArrayList<Moviebean> moviebeens) {
        ...
        String nextUrl = "http://www.ygdy8.com/html/gndy/oumei/list_7_";
