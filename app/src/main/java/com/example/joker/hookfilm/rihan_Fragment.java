...
public class rihan_Fragment extends Base_Fragment implements guonei_JsoupUtils.OnDataRight {
    ...
    public void initAdapter() {
        guonei_JsoupUtils guonei_jsoupUtils = new guonei_JsoupUtils("http://www.ygdy8.com/html/gndy/rihan/index.html", mRootActivity, mRecycle_main);
        guonei_jsoupUtils.setOnDataRight(this);
    }

    @Override
    public void getData(ArrayList<Moviebean> moviebeens) {
        String nextUrl = "http://www.ygdy8.com/html/gndy/rihan/list_6_";
